...
import banner from "../../../images/business.webp"
        ...
        <section className="relative min-h-[80vh] flex items-center px-[20px] md:px-0">
            ...
            <div className="relative z-10 md:w-11/12 mx-auto grid lg:grid-cols-2 gap-6 md:gap-12 items-center pt-20 pb-[20px] md:py-20 xl:pt-[170px]">
                <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                    <div className="inline-flex items-center gap-1 md:gap-2 px-1.5 md:px-3 py-0.5 md:py-1.5 rounded-full border border-[#0066FF]/40 bg-[#0066FF]/10 text-[#5AB1FF] text-[10px] md:text-[12px]"><Sparkles className='size-[12px] md:size-[14px]' />PROFESSIONAL BUSINESS WEBSITES</div>
                    <h1 className="mt-1.5 md:mt-3 font-asap text-[24px] md:text-[60px] font-bold md:leading-[1.08]">Turn visitors into <span className='block'>customers with a website</span> <span className="block bg-gradient-to-r from-[#0371E4] to-[#05AFFF] bg-clip-text text-transparent">built for your business.</span></h1>
                    <p className="mt-1.5 md:mt-3 text-[#FFFFFFB2] text-[13px] md:text-[18px] leading-relaxed max-w-[580px]">Build a professional online presence that helps customers discover your business, understand your services, build trust and contact you easily.</p>
                    <div className="flex items-end gap-2 mt-2 md:mt-4">
                        <span className="text-[30px] md:text-[52px] font-bold">₹7,999</span>
